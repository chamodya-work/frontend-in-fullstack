...
const Content = () => {
  ...
  function checkContent() {
    ...
    switch (inputContent) {
      case "Movie":
        document.querySelector(".container-box_addMovie").style.display =
          "block";
        document.querySelector(".container-box_addDoc").style.display = "none";
        document.querySelector(".container-box_addSeries").style.display =
          "none";
        break;
      case "TV Series":
        document.querySelector(".container-box_addSeries").style.display =
  ...
  const submitMovie = () => {
    ...
    const original_language_movie = document
      .getElementById("original_language_movie")
      .value.trim();
    const release_date_movie = document
      .getElementById("release_date_movie")
      .value.trim();
    const trailer_movie = document.getElementById("trailer_movie").value.trim();
    const backdrop_path_movie = document
      .getElementById("backdrop_path_movie")
      .value.trim();
    const poster_path_movie = document
      .getElementById("poster_path_movie")
      .value.trim();
    const vote_average_movie = document
      .getElementById("vote_average_movie")
      .value.trim();
    const adult_movie = document.getElementById("adult_movie").value.trim();
    const overview_movie = document
      .getElementById("overview_movie")
      .value.trim();
    const watch_time_movie = document
      .getElementById("watch_time_movie")
      .value.trim();
    ...
    if (
      isNaN(vote_average_movie) ||
      vote_average_movie < 0 ||
      vote_average_movie > 10
    ) {
  ...
  const submitSeries = () => {
    ...
    var original_language_series = document
      .getElementById("original_language_series")
      .value.trim();
    var release_date_series = document
      .getElementById("release_date_series")
      .value.trim();
    var trailer_series = document.getElementById("trailer_series").value.trim();
    var backdrop_path_series = document
      .getElementById("backdrop_path_series")
      .value.trim();
    var poster_path_series = document
      .getElementById("poster_path_series")
      .value.trim();
    var vote_average_series = document
      .getElementById("vote_average_series")
      .value.trim();
    var adult_series = document.getElementById("adult_series").value.trim();
    var overview_series = document
      .getElementById("overview_series")
      .value.trim();
    var num_of_seasons = document.getElementById("num_of_seasons").value.trim();
    var num_of_episodes = document
      .getElementById("num_of_episodes")
      .value.trim();
    ...
    if (
      isNaN(vote_average_series) ||
      vote_average_series < 0 ||
      vote_average_series > 10
    ) {
      alert("Vote average must be a number between 0 and 10.");
      return;
    }
  ...
  const submitDoc = () => {
    ...
    const original_language_doc = document
      .getElementById("original_language_doc")
      .value.trim();
    const release_date_doc = document
      .getElementById("release_date_doc")
      .value.trim();
    const trailer_doc = document.getElementById("trailer_doc").value.trim();
    const backdrop_path_doc = document
      .getElementById("backdrop_path_doc")
      .value.trim();
    const poster_path_doc = document
      .getElementById("poster_path_doc")
      .value.trim();
    const vote_average_doc = document
      .getElementById("vote_average_doc")
      .value.trim();
    ...
    const watch_time_doc = document
      .getElementById("watch_time_doc")
      .value.trim();

    // Validate required fields
    if (
      !name_doc ||
      !original_language_doc ||
      !release_date_doc ||
      !overview_doc ||
      !vote_average_doc ||
      !watch_time_doc
